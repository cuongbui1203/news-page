...
class wpstickysidebar_form_review_box {

    public $plugin_name = "WP Sticky Sidebar";

    public $plugin_slug = "wpstickysidebar";
        ...
        if (current_user_can('manage_options')) {
            ...
            <div
                ...
                <div class="review-box-default" id="default-review-box-<?php echo esc_attr($this->plugin_slug) ?>">
                    <p>
                        <?php printf(esc_html__("Hi there, it seems like %s is bringing you some value, and that's pretty awesome! Can you please show us some love and rate %s on WordPress? It'll only take 2 minutes of your time, and will really help us spread the word - %s, %s", "mystickysidebar"), "<b>".$this->plugin_name."</b>", $this->plugin_name, "<b>Gal Dubinski</b>", "Co-founder") ?>
                        <img width="30px" src="<?php echo esc_url(plugin_dir_url(__FILE__) . "images/premio-owner.png") ?>"/>
                    ...
                    <ul>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-hide-btn" href="https://wordpress.org/support/plugin/mystickysidebar/reviews/?filter=5" target="_blank"><?php esc_html_e("I'd love to help :) ",'mystickysidebar')?></a></li>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-future-btn" href="javascript:;"><?php esc_html_e("Not this time ",'mystickysidebar')?></a></li>
                        <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-hide-btn" href="javascript:;"><?php esc_html_e("I've already rated you ",'mystickysidebar')?></a></li>
                    </ul>
                </div>
                <div class="review-thanks-box" id="review-thanks-<?php echo esc_attr($this->plugin_slug) ?>">
                    ...
                    <div class="review-thanks-msg">
                        <div class="thanks-msg-title"><?php esc_html_e("You are awesome ",'mystickysidebar')?> &#128591;</div>
                        <div class="thanks-msg-desc"><?php esc_html_e("Thanks for your support, We really appreciate it!",'mystickysidebar')?></div>
                        <div class="thanks-msg-footer"><?php esc_html_e("Premio team ",'mystickysidebar')?></div>
                    </div>
                    <div class="clear clearfix"></div>
                </div>
            </div>
            <div class="<?php echo esc_attr($this->plugin_slug) ?>-review-box-popup">
                <div class="<?php echo esc_attr($this->plugin_slug) ?>-review-box-popup-content">
                    ...
                    <div class="<?php echo esc_attr($this->plugin_slug) ?>-review-box-title">
                        <?php esc_html_e("Would you like us to remind you about this later?",'mystickysidebar')?>
                    </div>
                    <div class="<?php echo esc_attr($this->plugin_slug) ?>-review-box-options">
                        <a href="javascript:;" data-days="3"><?php esc_html_e("Remind me in 3 days ",'mystickysidebar')?></a>
                        <a href="javascript:;" data-days="10"><?php esc_html_e("Remind me in 10 days ",'mystickysidebar')?></a>
...
$wpstickysidebar_form_review_box = new wpstickysidebar_form_review_box();